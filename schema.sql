-- =====================================================================
-- Sistema Mercadinho â€” Schema PostgreSQL
-- Use: psql "$DATABASE_URL" -f schema.sql
-- Idempotente: pode ser rodado mÃºltiplas vezes sem quebrar.
-- =====================================================================
...
DO $$ BEGIN
    CREATE TYPE payment_method AS ENUM ('Dinheiro', 'PIX', 'CrÃ©dito', 'DÃ©bito', 'Fiado');
EXCEPTION
    WHEN duplicate_object THEN NULL;
END $$;
